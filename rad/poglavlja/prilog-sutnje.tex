...
%    arhivirana izvan repozitorija uz SHA-256, jer nema pročišćen tekst.
% ============================================================
...
Oznake S12 do S23 nisu neprekinut niz. Tijekom izvoda
zabilježene su dvadeset i tri šutnje, numerirane redom kojim su nađene u
izvorima. Petnaest ih je razvijeno u jedanaest načina otkazivanja iz
odjeljka~\ref{sec:failure-modes}, gdje nose oznake A1 do E1, a jedna je
razrađena u odjeljku~\ref{sec:ogranicenja}. Sedam preostalih zadržava izvornu
oznaku, pa se svaka može pratiti do mjesta u izvodu na kojem je nastala. Rupe u
nizu su upravo one šutnje koje su prešle u tekst rada.

\begingroup
\small
\setlength{\tabcolsep}{4pt}
\renewcommand{\arraystretch}{1.25}
\begin{longtable}{@{}p{0.9cm}p{5.4cm}p{8.4cm}@{}}
...
S19 & Veza reference s evidentiranim prethodnim računom &
Schematron provjerava sadržaj reference, ne postojanje udaljenog
računa \cite{cen2026validationartefacts}. Fiskalizacijska šifra S012 ipak
zahtijeva evidentiran izvornik za ispravak. Nije razrađeno kako se ta
provjera povezuje sa svakom referencom na prethodni račun \cite{pu2026tehspec}. \\
