\section{Raspodijeljeni sustavi i tolerancija na greške}
...
% ------------------------------------------------------------
\subsection{Raspodijeljeni sustav i djelomični otkaz}
...
% ------------------------------------------------------------
\subsection{Pojmovi: kvar, pogreška i otkaz}
...
% ------------------------------------------------------------
\subsection{Klasifikacija otkaza}
...
% ------------------------------------------------------------
\subsection{Istek vremena i otkrivanje otkaza}
...
% ------------------------------------------------------------
\subsection{Jamstva dostave i potvrda ishoda}
